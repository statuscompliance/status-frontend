      ...
      <div className="app">
        ...
        <div className="sidebar">
          ...
          <nav className="navbar navbar-dark flex-column">
            <ul className="navbar-nav align-items-center">
              <li className="nav-item">
                <Link to="/catalogs" className="nav-link pt-serif-regular">
                  Catálogos
                </Link>
              </li>
              <li className="nav-item">
                <Link to="/mashups" className="nav-link pt-serif-regular">
                  Mashups
                </Link>
              </li>
              <li className="nav-item">
                <Link to="/" className="nav-link pt-serif-regular">
                  Logout
                </Link>
              </li>
              <li className="nav-item">
                <Link to="/profile" className="nav-link pt-serif-regular">
                  Profile
                </Link>
              </li>
            </ul>
          ...
          <div className="btn-container">
            <button className="btn btn-light pt-serif-regular" onClick={clean}>
              Disconnect
            </button>
          </div>
